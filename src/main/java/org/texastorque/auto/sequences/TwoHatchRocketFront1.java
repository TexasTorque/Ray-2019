...
public class TwoHatchRocketFront1 extends Sequence {
    ...
    protected void init() {
        ...
        Waypoint[] points = new Waypoint[] {
            new Waypoint(0, 0, 0),
            new Waypoint(4.5, 6, Pathfinder.d2r(35))
        };
        block2.add(new DrivePath(0, points, true, false));
        block2.add(new RotarySet(1, 2));
        block2.add(new DriveVisionTime(2, 1.2));
        block2.add(new ClawSet(3.2, false));
        ...
        block5.add(new DriveVisionTime(2, 1.2));
        block5.add(new ClawSet(3.2, true));
        ...
        block8.add(new DriveVisionTime(1.2, 1.2));
