...
/**
 * All forms of input, including driver/operator controllers and input from the
 * code itself.
 * 
...
public class Input {
    ...
    public void updateLift() {
        ...
        if (!LF_manualMode.get()) {
            ...
            // LF_modifier = 1;
            // } else if (operator.getDPADRight() || operator.getDPADDown() ||
    ...
    /**
     * true = hatch intake, cargo outtake false = cargo intake, hatch outtake
     */
