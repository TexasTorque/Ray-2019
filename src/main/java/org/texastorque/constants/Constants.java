...
public class Constants {
    ...
    public static final double DB_LOW_MAX_ACCEL = 7.0; // Low gear max acceleration (ft/s/s)
    ...
    public static final double DB_HIGH_MAX_ACCEL = 10.0;
    public static final double DB_HIGH_MAX_JERK = 100.0;
